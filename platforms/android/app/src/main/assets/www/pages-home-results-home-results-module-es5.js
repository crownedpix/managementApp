...
var PopmenuComponent = /** @class */ (function () {
    function PopmenuComponent(navCtrl, auth) {
...
var HomeResultsPage = /** @class */ (function () {
    function HomeResultsPage(navCtrl, menuCtrl, popoverCtrl, alertCtrl, modalCtrl, toastCtrl, storage, router, apiService) {
        this.navCtrl = navCtrl;
    ...
    HomeResultsPage.prototype.setCountry = function () {
        console.log('New country');
    };
    HomeResultsPage.prototype.getValue = function (val) {
        var total = this.value[val];
        if (total > 0) {
    ...
    HomeResultsPage.prototype.ionViewWillEnter = function () {
        ...
        var self = this;
        this.storage.get('totalRecords').then(function (val) {
            if (val) {
                self.value = val;
            }
            else {
    ...
    HomeResultsPage.prototype.gotoFrees = function () {
        this.navCtrl.navigateRoot('/freelancers');
    };
    HomeResultsPage.prototype.gotoClients = function () {
        this.navCtrl.navigateRoot('/clients');
    };
    HomeResultsPage.prototype.gotoProjects = function (project) {
    ...
    HomeResultsPage.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"] },
