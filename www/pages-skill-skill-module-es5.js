...
var SkillComponent = /** @class */ (function () {
    function SkillComponent(formBuilder, apiService, navCtrl, toastCtrl, storage) {
    ...
    SkillComponent.prototype.createSkill = function () {
        ...
        this.apiService.setSkills(value).subscribe(function (data) {
            ...
            _this.apiService.getSkills().subscribe(function (data) {
                _this.storage.set('skills', data['result']);
            });
...
//# sourceMappingURL=pages-skill-skill-module-es5.js.map