...
var FreelancersComponent = /** @class */ (function () {
    function FreelancersComponent(navCtrl, menuCtrl, popoverCtrl, modalCtrl, api, route, router, storage) {
    ...
    FreelancersComponent.prototype.ionViewWillEnter = function () {
        this.menuCtrl.enable(true);
        this.fetchFreelancers();
    };
    FreelancersComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    FreelancersComponent.prototype.fetchFreelancers = function () {
        var _this = this;
        console.log('test');
        var self = this;
        this.api.getFreelancers().subscribe(function (data) {
            ...
            _this.freelancers = data['result'];
        });
    };
    FreelancersComponent.prototype.sendSkills = function (data) {
    ...
    FreelancersComponent.prototype.setFilteredItems = function () {
        var self = this;
        if (this.searchType == 'name') {
            self.freelancers = this.freelancersData.filter(function (item) {
    ...
    FreelancersComponent.prototype.goto = function (value) {
    ...
    FreelancersComponent.prototype.settings = function () {
        this.navCtrl.navigateForward('settings');
    };
    FreelancersComponent.prototype.loadData = function (event) {
        setTimeout(function () {
            console.log('Done');
    ...
    // }
    FreelancersComponent.prototype.searchFilter = function () {
    ...
    FreelancersComponent.prototype.notifications = function (ev) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    FreelancersComponent.ctorParameters = function () { return [
...
var FreelancersModule = /** @class */ (function () {
    function FreelancersModule() {
    }
...
//# sourceMappingURL=pages-freelancers-freelancers-module-es5.js.map